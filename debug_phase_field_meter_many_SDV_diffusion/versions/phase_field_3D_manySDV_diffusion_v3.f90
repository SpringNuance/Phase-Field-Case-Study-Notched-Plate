...
!   compute the hydrostatic stress
    ...
    do kintk=1,ninpt
        ...
        ! if (kinc == 3) then
        !     print *, 'dev_S11 = ', dev_S11
        !     print *, 'dev_S22 = ', dev_S22
        !     print *, 'dev_S33 = ', dev_S33
        !     print *, 'dev_S12 = ', dev_S12
        !     print *, 'dev_S13 = ', dev_S13
        !     print *, 'dev_S23 = ', dev_S23
        !     print *, 'invariant_p = ', invariant_p
        !     print *, 'invariant_q = ', invariant_q
        !     print *, 'invariant_r = ', invariant_r
        !     print *, 'triaxiality = ', triaxiality
        !     print *, 'sig_trial_dev = ', sig_trial_dev
        !     print *, 'cosine_3_lode = ', cosine_3_lode
        !     print *, 'lode_unnormalized = ', lode_unnormalized
        ! endif
       ! print *, 'lode_unnormalized = ', lode_unnormalized
