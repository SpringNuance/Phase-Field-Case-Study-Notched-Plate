...
# Run by nguyenb5 on Tue Aug 13 14:49:38 2024
#
...
executeOnCaeStartup()
o2 = session.openOdb(name='phase_field_plate_uel_1_wtppm.odb')
#: Model: C:/LocalUserData/User-data/nguyenb5/CP1000 (all combined)/phase_field_isotropic_3d/benchmark_Emilio/H2_1_wtppm/phase_field_plate_uel_1_wtppm.odb
...
session.viewports['Viewport: 1'].makeCurrent()
odb = session.odbs['C:/LocalUserData/User-data/nguyenb5/CP1000 (all combined)/phase_field_isotropic_3d/benchmark_Emilio/H2_1_wtppm/phase_field_plate_uel_1_wtppm.odb']
...
session.writeXYReport(fileName='FD_curve_1_wtppm.txt', appendMode=OFF, xyData=(
    x0, x1))
